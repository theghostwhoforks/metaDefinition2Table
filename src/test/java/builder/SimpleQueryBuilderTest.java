...
public class SimpleQueryBuilderTest {
    ...
    public void shouldBuildACreateTableQueryWithSubForms() throws IOException {
        ...
        FormTableCreateQueryMultiMap formTableCreateQueryMultiMap = TableQueryBuilder.with().formDefinition(data).create();
        ...
        assertEquals(expectedTableCreateQuery, formTableCreateQueryMultiMap.getTableQuery().asSql());
        ...
        List<Query> actual = formTableCreateQueryMultiMap.getLinkedTableQueries();
